...
class WindowWebLayoutContractTests(unittest.TestCase):
    ...
    def test_speaker_panel_matches_draft_contract(self) -> None:
        ...
        self.assertIn(".speaker-item { --speaker-color:transparent; position:relative; min-width:0; display:grid; margin-top:12px;", HTML)
        ...
        self.assertIn(".speaker-item-summary { width:100%; min-height:60px; display:grid; grid-template-columns:minmax(0,1fr);", HTML)
