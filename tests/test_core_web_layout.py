...
class WindowWebLayoutContractTests(unittest.TestCase):
    ...
    def test_speaker_panel_matches_draft_contract(self) -> None:
        ...
        self.assertIn(".speaker-item.live-speaker { z-index:1; background:color-mix(in srgb, var(--speaker-color) 18%, #0F161F);", HTML)
        ...
        self.assertIn("padding:17px 10px 9px 12px;", HTML)
