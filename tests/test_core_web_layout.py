...
class WindowWebLayoutContractTests(unittest.TestCase):
    ...
    def test_speaker_panel_matches_draft_contract(self) -> None:
        ...
        self.assertIn('>+ Create Person</button>', HTML)
        ...
        self.assertIn('window.prompt("New Person name:', HTML)
    ...
    def test_settings_layout_keeps_person_controls_in_a_readable_flow(self) -> None:
        ...
        self.assertIn("People and Voice profiles", HTML)
        ...
        self.assertIn('recognition.className = "person-recognition person-policy-toggle";', HTML)
