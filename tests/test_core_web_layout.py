...
class WindowWebLayoutContractTests(unittest.TestCase):
    ...
    def test_media_area_matches_draft_contract(self) -> None:
        ...
        self.assertIn(".media-controls { min-width:0; min-height:100%; display:grid; grid-template-rows:auto auto minmax(0,1fr) auto;", HTML)
        self.assertIn('id="fastProcessing" type="checkbox"', HTML)
        self.assertIn(".media-actions { align-self:end; justify-self:start; display:flex;", HTML)
        self.assertIn(".media-action { width:40px; height:40px; display:grid;", HTML)
        self.assertIn('id="popoutMedia" class="media-action"', HTML)
    ...
    def test_speaker_panel_matches_draft_contract(self) -> None:
        ...
        self.assertIn(".speaker-list { width:100%; min-width:0; max-width:100%; min-height:0; display:grid; grid-template-columns:minmax(0,1fr);", HTML)
        self.assertIn("overflow-x:hidden; overflow-y:auto;", HTML)
        self.assertIn(".speaker-item { --speaker-color:transparent; position:relative; width:100%; min-width:0; max-width:100%; display:grid; margin-top:12px;", HTML)
        self.assertIn(".speaker-item.live-speaker { z-index:1; border-bottom-color:color-mix(in srgb, var(--speaker-color) 78%, var(--line)); background-color:color-mix(in srgb, var(--speaker-color) 18%, #0F161F);", HTML)
        ...
        self.assertIn(".speaker-summary-header { min-width:0; display:grid; grid-template-columns:minmax(0,1fr) auto;", HTML)
        self.assertIn(".speaker-summary-body { min-width:0; display:flex; flex-wrap:wrap; align-items:center; gap:4px 8px; }", HTML)
        self.assertIn(".speaker-identity-controls .speaker-identity-button", HTML)
        self.assertIn("min-height: 25px;", HTML)
        self.assertIn("border-bottom:1px solid color-mix(in srgb, var(--speaker-color) 42%, var(--line));", HTML)
        self.assertIn(".speaker-title-row { min-width:0; display:flex; align-items:center; gap:7px; }", HTML)
        self.assertIn(".speaker-status-row { min-width:0; display:flex; flex-wrap:wrap; align-items:center; gap:6px; }", HTML)
        self.assertIn("padding:17px 10px 8px 12px;", HTML)
        self.assertIn(".speaker-item-summary { min-height:58px; padding:17px 9px 8px; }", HTML)
        self.assertNotIn(".speaker-item.live-speaker .speaker-item-summary { padding-top:", HTML)
        self.assertIn(".speaker-live-indicator { position:absolute; z-index:2; top:-11px; right:0;", HTML)
        self.assertIn("white-space:nowrap;", HTML)
        self.assertIn("transition:background-color 1100ms linear, border-bottom-color 1100ms linear, box-shadow 1100ms linear;", HTML)
        self.assertIn("border-bottom-color:color-mix(in srgb, var(--speaker-color) 78%, var(--line));", HTML)
        self.assertIn("transition-duration:175ms; transition-timing-function:cubic-bezier(.3,.705,.6,1);", HTML)
        self.assertIn("opacity:0; visibility:hidden; pointer-events:none;", HTML)
        self.assertIn(".speaker-item.live-speaker > .speaker-live-indicator", HTML)
        self.assertIn("opacity 175ms cubic-bezier(.3,.705,.6,1)", HTML)
        self.assertIn("opacity 1100ms linear", HTML)
        self.assertIn("animation:livePulse 1s ease-in-out infinite;", HTML)
        self.assertIn("@keyframes livePulse", HTML)
        self.assertIn("@media (prefers-reduced-motion: reduce)", HTML)
        self.assertIn(".speaker-item-summary { width:100%; min-width:0; max-width:100%; min-height:60px; display:grid; grid-template-columns:minmax(0,1fr);", HTML)
        self.assertIn("box-shadow:inset 4px 0 0 var(--speaker-color), inset 7px 0 14px transparent;", HTML)
        ...
        self.assertIn(".speaker-item-tail { min-width:max-content; align-self:start; display:flex; align-items:center;", HTML)
        ...
        self.assertIn('row.appendChild(createSpeakerLiveIndicator());', HTML)
        self.assertNotIn('statusRow.appendChild(createSpeakerLiveIndicator());', HTML)
        self.assertNotIn('titleRow.appendChild(createSpeakerLiveIndicator());', HTML)
        self.assertNotIn('indicator.remove();', HTML)
        ...
        self.assertIn("expected_sentence_count: sentenceTotal", HTML)
        self.assertIn('id="autoRemoveEmptySpeakers" type="checkbox" checked', HTML)
        self.assertIn("Remove empty Speakers automatically", HTML)
        self.assertIn("autoRemoveEmptySpeakersStorageKey", HTML)
        self.assertIn('post("/api/speakers/remove-empty", {speaker_ids: speakerIds.map(toInternalSpeakerId)})', HTML)
        self.assertIn("storedBooleanValue(autoRemoveEmptySpeakersStorageKey, true)", HTML)
        self.assertIn('function createSpeakerDeleteButton(speaker, label = "Delete Speaker", options = {})', HTML)
        self.assertIn('createSpeakerDeleteButton(speaker, "Remove empty Speaker", {emptyOnly: true})', HTML)
